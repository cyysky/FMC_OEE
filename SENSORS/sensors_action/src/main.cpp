...
unsigned long wm_timeout   = 120 * 1000; // milli seconds to run for
...
void software_serial_event()
{
    ...
    // add it to the inputString:
    if (!((inChar==(char)0x1A)||(inChar==(char)0xFF))){ // Clear FF FF FF 1A bytes feedback from TJC touch sreen
        str_in += inChar;
...
////////////////////////////////////////////////////////////////////////////// BMP280
  ...
  if (!bmp.begin(0x76)) {//https://forum.arduino.cc/t/bmp280-hw-611-e-p-280-library-sensor-fault/590528/2
...
void loop()
{
  ...
  do_wm(); 
/////////////////////////////////////////////////////////////////////////////// SENSOR UPDATE
  if(is_ready(&sensors_previous_mills,&sensors_delay))
  {
