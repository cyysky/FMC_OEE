...
mc = db.Table('Temp_Q1', metadata, autoload=True, autoload_with=engine)
connection.close()
...
def on_message(client, userdata, message):
    ...
    try:
        #json_object = json.loads({"temp":msg})      
...
def mqtt_start():
    global mqtt_client
    mqtt_client = mqtt.Client("server-ir_temperature")
